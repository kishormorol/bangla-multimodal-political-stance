...
% Figure removed: method1.png includes "Proposed Model Architecture" diagram
% that contradicts the benchmark framing. Re-add with a cropped version showing
% only the pipeline overview if space permits.
